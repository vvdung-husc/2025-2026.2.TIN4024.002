...
#define BLYNK_TEMPLATE_ID "TMPL66zhGAfbQ"
#define BLYNK_TEMPLATE_NAME "ESP32 API"
#define BLYNK_AUTH_TOKEN "jW7UTYHP_G5y7ur4iBjT6XN0Bk8kmdBs"
...
void onceCalled(){
  ...
  if (ip4Info.latitude.length() > 0 && ip4Info.longtitude.length() > 0) {
    ...
    Blynk.virtualWrite(V0, "Nguyễn Thị Kim Chi");   // Thêm mới: Gửi tên vào V0
