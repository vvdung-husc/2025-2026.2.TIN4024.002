...
// ===== BLYNK CONFIG =====
#define BLYNK_TEMPLATE_ID "TMPL6pgUbE4D2"
#define BLYNK_TEMPLATE_NAME "ESP32 Smart Fan"
#define BLYNK_AUTH_TOKEN "ro7Ybe-CwyGScWCpdImexJ87ENM2VfWR"
...
void sendDataToBlynk(float t, float h)
{
    ...
    if (isFanOn)
    {
        ...
        Blynk.virtualWrite(V3, "ĐANG BẬT");
    }
    else
    {
        Blynk.virtualWrite(V1, 0);
        Blynk.virtualWrite(V3, "ĐANG TẮT");
    }

    if (t >= TEMP_ON)
        Blynk.virtualWrite(V4, "🔥 NHIỆT ĐỘ CAO!");
    else
        Blynk.virtualWrite(V4, "✅ NHIỆT ĐỘ BÌNH THƯỜNG");
    Blynk.virtualWrite(V6, "ĐIỀU KHIỂN QUẠT DỰA TRÊN NHIỆT ĐỘ");
}
