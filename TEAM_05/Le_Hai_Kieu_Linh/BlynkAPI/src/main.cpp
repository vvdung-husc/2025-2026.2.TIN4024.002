...
#define BLYNK_TEMPLATE_ID "TMPL6iz1Ixhoo"
#define BLYNK_TEMPLATE_NAME "ESP32 API"
#define BLYNK_AUTH_TOKEN "UA7Bb9GZvyVlJt9AGVEVDN5kx4vOvusu"
...
void onceCalled(){
  ...
  if (ip4Info.latitude.length() > 0 && ip4Info.longtitude.length() > 0) {
    ...
    Blynk.virtualWrite(V0, "Lê Hải Kiều Linh");   // Thêm mới: Gửi tên vào V0
