...
#define OPENWEATHERMAP_KEY "b168fb64e16342ad0c232669dd6a9f62" //Thay KEY của bạn vào đây
...
void onceCalled(){
  ...
  if (done_) return;
  done_ = true;
  String link = StringFormat("http://www.google.com/maps/place/%s,%s",ip4Info.latitude.c_str(),ip4Info.longtitude.c_str());
  ...
  Blynk.virtualWrite(V4, "Lê Hữu Hoàng Nam");
}
